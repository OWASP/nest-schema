...
@pytest.mark.parametrize(
    ...
    [
        ...
        (
            ...
            "$.platform: 'telegram' is not one of ['discord', 'github-discussions', 'slack', 'matrix', 'reddit']",
        ),
        (
            "platform_null.yaml",
            "$.platform: None is not one of ['discord', 'github-discussions', 'slack', 'matrix', 'reddit']",
        ),
